		...
		<nav class="navbar navbar-expand-lg navbar-light bg-success">
			<div class="container">
				...
				<div class="navbar-nav ml-auto" id="navbar-list">
					...
					<a class="nav-link" href="CrearCapacitacion" style="color: white;">Crear
						Capacitación</a> <a class="nav-link" href="ListarCapacitaciones"
						style="color: white;">Listar Capacitaciones</a> <a
						class="nav-link" href="ListarUsuarios" style="color: white;">Listar
						Usuarios</a> <a class="nav-link" href="login"
