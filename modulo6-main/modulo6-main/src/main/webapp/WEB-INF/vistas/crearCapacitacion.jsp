...
<div class="contacto" style="display: flex; justify-content: center;">
    <form action="/modulo6/CrearCapacitacion" method="post" onsubmit="return enviarFormulario(event)">
			...
			<br> <span id="idCapacitacionValidationMessage"
				style="color: red;"></span> <br> <label for="nombre">Ingrese
				Nombre de la Capacitación:</label><br> <input type="text" id="nombre"
				name="nombre" title="Campo Obligatorio"><br> <br>
			<span id="nombreValidationMessage" style="color: red;"></span>
			 <label for="nombre">Ingrese Rut:</label><br> <input
			...
			<br> <label for="nombre">Ingrese el Día de la
				Capacitación:</label><br> <input type="text" id="dia" name="dia"
				pattern="(lunes|martes|miercoles|jueves|viernes|sabado|domingo)"
				title="Por favor, introduzca un día válido (lunes, martes, miércoles, jueves, viernes, sábado o domingo)."><br>
			<br> <span id="diaValidationMessage" style="color: red;"></span>
			<br> <label for="nombre">Ingrese la Hora de la
				Capacitación:</label><br> <input type="text" id="hora" name="hora"
				title="Campo Obligatorio / en Formato HH:MM"><br> <br>
			...
			<br> <span id="lugarValidationMessage" style="color: red;"></span>
			<br> <label for="nombre">Ingrese la Duración de la
				Capacitación:</label><br> <input type="text" id="duracion"
				name="duracion" title="Campo Obligatorio / Max 70 Caracteres."><br>
			<br> <span id="duracionValidationMessage" style="color: red;"></span>
			<br> <label for="nombre">Ingrese la Cantidad de
				...
				title="Campo Obligatorio / Debe Introducir un Valor Númerico."><br>
			<br> <span id="cantidadAsistentesValidationMessage"
